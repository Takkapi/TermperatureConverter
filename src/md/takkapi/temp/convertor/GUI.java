package md.takkapi.temp.convertor;
...
public class GUI implements ActionListener {
    ...
    public static void main(String[] args) {
        ...
        convertFahrenheit = new JButton("Ghita prostu");
        convertFahrenheit.setBounds(999, 9999, 1000, 20);
        convertFahrenheit.addActionListener(new GUI());
        panel.add(convertFahrenheit);
        
        // Ghita daca vezi asta nu sterge ca esti gay XDDD
